...
const Women = () => {
    ...
    useEffect(()=>{
        setHomeSection(womenPageData.find((section)=>section.section === 'homeSection')?.content.images)
        setRecommendedPerfumes(womenPageData.find((section)=>section.section === 'recommendedPerfumes')?.content.images)
        setSpecialBackgrounds(womenPageData.find((section)=>section.section === 'specialBackgrounds')?.content.images)
        setSpecialPerfumes(womenPageData.find((section)=>section.section === 'specialPerfumes')?.content.images)
    },[womenPageData])
        ...
        >
            ...
            <div className='bg-black p-5 w-full flex flex-col gap-y-2 rounded-md '>
                ...
                <div className='flex flex-row items-center justify-between'>
                    ...
                    <div className='p-2 px-5 bg-[#323d4e] rounded-md flex flex-row gap-2 items-center cursor-pointer' onClick={()=>openHomeSectionModal('addAnotherImage')}>
