  ...
  return (
    <div style={{ overflowX: 'auto' }}>
      ...
      <DataTable
        ...
        columns={columns}
        data={dataEntered !== undefined ? dataEntered : data}
        fixedHeader
